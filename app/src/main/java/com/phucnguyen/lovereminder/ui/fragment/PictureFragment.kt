...
class PictureFragment : Fragment(), View.OnClickListener {
    private var gvPictures: GridView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ImageAdapter(requireActivity(), images)
    }
    ...
    override fun onCreateView(
        ...
        pictureViewModel = ViewModelProvider(requireActivity()).get(
        ...
        pictureViewModel!!.images.observe(viewLifecycleOwner) { images ->
//            this@PictureFragment.images = images
            if (images.size == 0) {
                linearLayout!!.visibility = View.VISIBLE
                gvPictures!!.visibility = View.GONE
            } else {
                linearLayout!!.visibility = View.GONE
                gvPictures!!.visibility = View.VISIBLE
